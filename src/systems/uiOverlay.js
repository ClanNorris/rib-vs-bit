...
export function createUiOverlaySystem(scene) {
  ...
  function showGameOver({ winnerId, onRestart } = {}) {
    ...
    const mobileWinOffset = isMobileDevice ? -80 : 0;   // gentle upward shift only
    ...
    createTrackedRectangle(centerX, centerY + mobileWinOffset, scene.scale.width, scene.scale.height, 0x020617, 0.95);
